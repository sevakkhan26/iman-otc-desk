...
export const BLOCKED_FA: Record<BlockedReasonCode, BlockedExplanation> = {
  ...
  sequence_gap: {
    short: "شکاف توالی بازار",
    detail: "یک یا چند رویداد دفتر سفارش جا افتاده است؛ تا دریافت snapshot کامل مسیر بسته می‌ماند."
  },
  snapshot_resync: {
    short: "در حال همگام‌سازی",
    detail: "اتصال بازار دوباره برقرار شده اما snapshot کامل بازیابی هنوز تأیید نشده است."
  },
  incoherent_event_time: {
    short: "زمان دو سمت ناهماهنگ",
    detail: "رویدادهای خرید و فروش خارج از پنجرهٔ زمانی مشترک‌اند و با هم مبنای تصمیم نمی‌شوند."
  },
