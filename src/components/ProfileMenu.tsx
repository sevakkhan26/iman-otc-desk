...
/**
 * Header profile control: glass icon + portaled Apple glass menu.
 * Menu mounts under body so header backdrop-filter / overflow cannot clip it.
 */
  ...
  return (
    <div className="profile-menu">
      ...
      >
        ...
        {role === "admin" ? (
          <Link href="/settings" className="profile-menu-item glass-menu-item" role="menuitem" onClick={close}>
            <Settings aria-hidden="true" size={16} strokeWidth={1.75} />
            <span>تنظیمات</span>
          </Link>
        ) : null}
        <Link href="/help" className="profile-menu-item glass-menu-item" role="menuitem" onClick={close}>
          <CircleHelp aria-hidden="true" size={16} strokeWidth={1.75} />
          <span>راهنما</span>
        </Link>
        <button
          type="button"
          className="profile-menu-item glass-menu-item profile-menu-logout"
          role="menuitem"
          disabled={loggingOut}
