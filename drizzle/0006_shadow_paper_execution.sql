...
CREATE TABLE IF NOT EXISTS "shadow_paper_ledger" (
  ...
  "mark_price_toman" bigint,
  "cash_pnl_irt_toman" bigint,
  "inventory_delta_usdt_micros" bigint,
  "sell_fee_value_toman" bigint,
  "economic_net_pnl_toman" bigint,
  "risk_adjusted_pnl_toman" bigint,
