  ...
  for (const d of evaluation.decisions) {
    if (d.kind === "EXECUTE") {
      fills.push({
        ...
        buyFeeBasis: d.plan.buyLeg.feeBasis,
        sellFeeBasis: d.plan.sellLeg.feeBasis,
        ...
        netPnlToman: d.plan.netPnlToman,
        netPnlAfterBufferToman: d.plan.netPnlAfterBufferToman,
        usdtDriftMicros: d.plan.usdtDriftMicros,
